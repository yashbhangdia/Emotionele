def angry(num, op):
    ...
    if(num==0):
        ...
        if(op == "I have it under control"):
            return ["Good to know that. Maybe a change of environment can help. Try staying away from what/who made you angry for some time. To take your mind off, you can attempt this quiz: I'm sure this'll help. Feel free to come back and chat if have any other trouble. Bye for now!"], -1, []
    if(num==1):
